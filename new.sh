...
echo
echo $i"────────────────────────────────   ─────"
echo $i"|"$me"1"$i" |"$cy" HACKING CLONE ACCOUNT    "$i"|"$i"    |"$cy" D"$i" |"
echo $i"|"$me"2"$i" |"$cy" BRUTEFORCE    SGB team   "$i"|"$i"    |"$cy" E"$i" |"
...
echo $i"|"$me"7"$i" |"$cy" BOT ACCOUNT              "$i"|"$i"    |"$cy" #"$i" |"
echo $i"|"$me"8"$i" |"$cy" BOT ATTACK PASSWORD      "$i"|"$i"    |"$cy" R"$i" |"
echo $i"|"$me"9"$i" |"$cy" TRACKING IP LOCATION     "$i"|"$i"    |"$cy" O"$i" |"
echo $i"|"$me"10"$i"|"$cy" PHISING ACCOUNT          "$i"|"$i"    |"$cy" H"$i" |"
echo $i"────────────────────────────────"$i"   |"$cy" A"$i" |"
echo $i"|"$me"11"$i"|"$cy" INSTALL BAHAN            "$i"|"$i"    |"$cy" D"$i" |"
echo $i"|"$me"12"$i"|"$cy" KELUAR DARI PROGRAM      "$i"|"$i"    |"$cy" I"$i" |"
echo $i"────────────────────────────────   ─────"
echo
